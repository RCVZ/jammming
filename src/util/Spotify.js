...
const Spotify = {
  getAccesToken() {
    ...
    if (accessTokenPara && expiresInPara) {
      ...
      const authorizeUrl = `https://accounts.spotify.com/authorize?client_id=${clientId}&redirect_uri=http://localhost:3000/&scope=playlist-modify-public&response_type=token`;
